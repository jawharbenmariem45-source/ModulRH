							    ...
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												<th class="cell">#</th>
												<th class="cell">Nom</th>												<th class="cell"></th>
											</tr>
										</thead>
										<tbody>
                                            ...
                                            @forelse($departements as $departement)
												...
												<td><a class="btn-sm app-btn-secondary" href="{{ route('departement.destroy', $departement->id) }}">Retirer</a></td>

											</tr> 
                                            @empty
                                            <tr>
												<td class="cell" colspan="2">Aucun departement ajoutes</td>
											</tr> 
                                            @endforelse
										</tbody>
									</table>
